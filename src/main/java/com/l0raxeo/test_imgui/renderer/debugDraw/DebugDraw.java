package com.l0raxeo.test_imgui.renderer.debugDraw;

import com.l0raxeo.test_imgui.assetFiles.AssetPool;
...
public class DebugDraw
{
    ...
    public static void draw() {
        ...
        // Use our shader
        shader.use();
        shader.uploadMat4f("uProjection", SceneManager.getActiveScene().camera.getProjectionMatrix());
        shader.uploadMat4f("uView", SceneManager.getActiveScene().camera.getViewMatrix());
